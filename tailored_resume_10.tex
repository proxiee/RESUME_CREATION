...
\resumeItem{Highly skilled Software Engineer with 2+ years of experience in full-stack development and Agile methodologies. Proven ability to design, develop, and deploy robust, scalable software solutions using Java/Spring Boot and Python.  Expertise in database design (SQL), cloud technologies (AWS), and containerization (Docker, Kubernetes). Eager to contribute to a collaborative team environment at Fortra.}
...
\resumeItemListStart
\resumeItem{Developed and deployed 5+ full-stack features for enterprise systems using Spring Boot (Java) and React, adhering to best practices for maintainability and scalability.}
\resumeItem{Collaborated with product owners and Agile team to deliver 3 projects on-time and within budget, improving API response times by 15\%.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Identified and resolved 100+ bugs in enterprise applications, resulting in a 10\% reduction in reported issues for key modules.}
\resumeItem{Improved code quality and reliability by authoring comprehensive technical documentation and enhancing test automation procedures.}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-17pt}
...
\resumeItemListStart
\resumeItem{Designed and implemented a new feature using Spring Boot and PostgreSQL, improving data processing speed by 20\% and reducing error rates by 15\%.}
\resumeItem{Collaborated with a team of 3 developers using Agile methodologies, delivering the project on time and within budget.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Cloud-Based Microservice Architecture}}{\textit{Jun 2024 - Present}}
\resumeItemListStart
\resumeItem{Developed a scalable microservice architecture using Docker, Kubernetes, and AWS, improving system resilience and reducing deployment time by 50\%.}
\resumeItem{Implemented CI/CD pipelines using Jenkins, automating deployment and testing processes.  Successfully mentored a junior developer on the project.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Improved Data Analytics Dashboard}}{\textit{Sep 2023-Dec 2023}}
\resumeItemListStart
\resumeItem{Developed a new data analytics dashboard using Python and SQL, improving data visualization and providing actionable insights to stakeholders.}
\resumeItem{Implemented robust security measures, ensuring data privacy and compliance with industry standards.}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-17pt}
