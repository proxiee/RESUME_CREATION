...
\resumeItem{Highly motivated recent graduate seeking a Junior Web Developer role. Proven ability in full-stack development,  delivering high-quality, maintainable code and optimizing user experience.  Expertise in Java, JavaScript frameworks (React/Vue.js preferred), and agile methodologies. Eager to contribute to a collaborative team and make a significant impact.}
...
\resumeItemListStart
\resumeItem{Developed and deployed full-stack features for enterprise systems using Spring Boot (Java) and modern front-end frameworks, resulting in improved code maintainability and extensibility.}
\resumeItem{Collaborated with stakeholders to translate user requirements into technical specifications, delivering robust solutions within an Agile environment; improved API response times by 15\%.}
\resumeItemListEnd
...
\resumeSubHeadingListStart
\resumeProjectHeading{\textbf{Responsive E-commerce Website Redesign}}{\textit{Jan 2024-May 2025}}
\resumeItemListStart
\resumeItem{Redesigned an e-commerce website using React, improving page load speed by 30\% and increasing conversion rates by 15\% through A/B testing and UI/UX optimization.}
\resumeItem{Implemented responsive design principles, ensuring optimal user experience across various devices and screen sizes.  Integrated secure payment gateway and enhanced SEO.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Interactive Data Visualization Dashboard}}{\textit{Jun 2024 - Present}}
\resumeItemListStart
\resumeItem{Developed an interactive data visualization dashboard using Vue.js and D3.js, allowing users to explore complex datasets with intuitive filtering and sorting capabilities.}
\resumeItem{Improved data accessibility and understanding for 100+ users through clear data representation and user-friendly interactions.}
\resumeItemListEnd\vspace{-6pt}
\resumeProjectHeading{\textbf{Dynamic Web Application with User Authentication}}{\textit{Sep 2023-Dec 2023}}
\resumeItemListStart
\resumeItem{Built a dynamic web application using Node.js and Express.js with robust user authentication and authorization features.}
\resumeItem{Implemented secure data handling practices, ensuring user data privacy and protecting against common web vulnerabilities.}
\resumeItemListEnd
\resumeSubHeadingListEnd
\vspace{-17pt}
